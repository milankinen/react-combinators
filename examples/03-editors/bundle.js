...
var _reactCombinatorsBaconjs = require("react-combinators/baconjs");

function Counter(initial) {
  var inc = createAction();
  var dec = createAction();
  var value = inc.$.map(1).merge(dec.$.map(-1)).scan(initial, function (state, step) {
    return state + step;
  });
  return { value: value, inc: inc, dec: dec };
}

function Name(initialFirst, initialLast) {
  var setFirst = createAction();
  var setLast = createAction();
  var first = setFirst.$.toProperty(initialFirst);
  var last = setLast.$.toProperty(initialLast);
  return { first: first, last: last, setFirst: setFirst, setLast: setLast };
}

function App() {
  var modifySelection = createAction();
  var addEditor = createAction();

  var selection = modifySelection.$.map(function (id) {
    return ({
      counter: { create: function create() {
          return Counter(0);
        }, render: renderCounter },
      name: { create: function create() {
          return Name("Foo", "Bar");
        }, render: renderNameEditor }
    })[id];
  }).startWith({ create: function create() {
      return Counter(0);
    }, render: renderCounter });

  var editors = selection.sampledBy(addEditor.$).scan([], function (editors, _ref) {
    var create = _ref.create;
    var render = _ref.render;
    return [].concat(_toConsumableArray(editors), [{ editor: create(), render: render }]);
  });

  var numEditors = editors.map(".length");

  return _react2["default"].createElement(
    _reactCombinatorsBaconjs.Combinator,
    null,
    _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          "select",
          { onChange: function (e) {
              return modifySelection(e.target.value);
            } },
          _react2["default"].createElement(
            "option",
            { value: "counter" },
      ...
      _react2["default"].createElement(
        "div",
        null,
        editors.map(function (editors) {
          return editors.map(function (_ref2) {
            var editor = _ref2.editor;
            var render = _ref2.render;
            return [_react2["default"].createElement("hr", null), render(editor)];
          });
        })
      )
    )
...
function renderNameEditor(_ref4) {
  var first = _ref4.first;
  var last = _ref4.last;
  var setFirst = _ref4.setFirst;
  var setLast = _ref4.setLast;
  ...
  return _react2["default"].createElement(
    ...
    _react2["default"].createElement(
      ...
      null,
      "First name: ",
      _react2["default"].createElement("input", { value: first, onChange: function (e) {
          return setFirst(e.target.value);
        } }),
      " ",
      _react2["default"].createElement("br", null),
      "Last name: ",
      _react2["default"].createElement("input", { value: last, onChange: function (e) {
...
function createAction() {
  ...
  var creator = function creator(val) {
    return bus.push(val);
  };
  creator.$ = bus;
  return creator;
...
},{"baconjs":2,"react":166,"react-combinators/baconjs":4,"react-dom":10}],2:[function(require,module,exports){
(function (global){
(function() {
...
},{"./lib/baconjs/Combinator":5,"./lib/baconjs/combineVDOM":6,"./lib/baconjs/createComponent":7,"./lib/baconjs/createContainer":8}],5:[function(require,module,exports){
"use strict";
...
var _combineVDOM = require("./combineVDOM");

var _combineVDOM2 = _interopRequireDefault(_combineVDOM);
 ...
 * </Combinator>
 */
var Combinator = (0, _createComponent2["default"])(function (_ref) {
  var children = _ref.children;
  return children.flatMapLatest(_combineVDOM2["default"]);
});

exports["default"] = Combinator;
module.exports = exports["default"];

},{"./combineVDOM":6,"./createComponent":7}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports["default"] = combineVDOM;
...
function combineVDOM(vdom) {
  var obs = resolveObservables(vdom, []);
  if ((0, _util.isEmpty)(obs)) {
    return _baconjs2["default"].constant(vdom);
  } else {
    return _baconjs2["default"].combineAsArray(obs).map(function (values) {
      return assignObservableValues(vdom, (0, _util.zip)(obs, values));
    });
  }

  function resolveObservables(el, obs) {
    var propKeys = Object.keys(el.props || {});
    for (var k = 0; k < propKeys.length; k++) {
      var key = propKeys[k];
      var prop = el.props[key];
      if (key === "children") {
        var children = (0, _util.isArray)(prop) ? prop : [prop];
        for (var i = 0; i < children.length; i++) {
          var child = children[i];
          if (isObs(child) && !(0, _util.contains)(obs, child)) {
            obs.push(child);
          } else if ((0, _reactLibReactElement.isValidElement)(child) && !isCombinator(child)) {
            resolveObservables(child, obs);
          }
        }
      } else {
        if (isObs(prop) && !(0, _util.contains)(obs, prop)) {
          obs.push(prop);
        }
      }
    }
  ...
  function assignObservableValues(el, obsValues) {
    ...
    var _loop = function (k) {
      ...
      if (key === "children") {
        ...
        var _loop2 = function (i) {
          var child = children[i];
          if (isObs(child)) {
            newChildren.push((0, _util.find)(obsValues, function (r) {
              return r[0] === child;
            })[1]);
          } else if ((0, _reactLibReactElement.isValidElement)(child) && !isCombinator(child)) {
        ...
        newProps.children = (0, _util.isArray)(prop) ? newChildren : newChildren[0];
      } else {
        if (isObs(prop)) {
          newProps[key] = (0, _util.find)(obsValues, function (r) {
            return r[0] === prop;
          })[1];
        } else {
          newProps[key] = prop;
    ...
    return (0, _reactLibReactElement.cloneAndReplaceProps)(el, newProps);
  }
}

function isCombinator(el) {
  return el && el.type === _Combinator2["default"];
}

function isObs(x) {
  return x && x instanceof _baconjs2["default"].Observable;
}
module.exports = exports["default"];

},{"../util":9,"./Combinator":5,"baconjs":2,"react/lib/ReactElement":62}],7:[function(require,module,exports){
(function (process){
"use strict";
...
function createComponent(renderFn) {
  return _react2["default"].createClass({
    getInitialState: function getInitialState() {
      var propsBuses = (0, _util.zipObject)((0, _util.keys)(this.props), (0, _util.values)(this.props).map(function (val) {
        return new _baconjs2["default"].Bus();
      }));

      var propsS = (0, _util.zipObject)((0, _util.keys)(this.props), (0, _util.zip)((0, _util.values)(propsBuses), (0, _util.values)(this.props)).map(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2);

        var bus = _ref2[0];
        var initial = _ref2[1];
        return bus.startWith(initial).skipDuplicates();
      }));

      return {
        propsBuses: propsBuses,
    ...
    componentWillMount: function componentWillMount() {
      ...
      var updateVDOM = function updateVDOM(vdom) {
        return _this.setState({ vdom: vdom });
      };
      if (process.browser) {
    ...
    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
      ...
      (0, _util.keys)(nextProps).forEach(function (propName) {
        var bus = _this2.state.propsBuses[propName];
        if (!bus) {
          console.warn("Trying to pass property \"" + propName + "\" that is not set during the component creation.", "Ignoring this property.");
        } else {
...
},{"../util":9,"_process":3,"baconjs":2,"react":166}],8:[function(require,module,exports){
"use strict";
...
function createContainer(stateP, PureComponent) {
  return (0, _createComponent2["default"])(stateP.map(PureComponent));
}

module.exports = exports["default"];

},{"./createComponent":7}],9:[function(require,module,exports){
"use strict";
...
exports["default"] = {
  keys: keys, values: values, zipObject: zipObject, zip: zip, isArray: isArray, isEmpty: isEmpty, contains: contains, find: find
};
...
function zip() {
  ...
  var len = Math.max.apply(Math, _toConsumableArray(arrays.map(function (a) {
    return a.length;
  })));
  var result = [];
  for (var i = 0; i < len; i++) {
...
},{"baconjs":2}],10:[function(require,module,exports){
'use strict';
...
},{"./CSSProperty":13,"./ReactPerf":81,"./dangerousStyleValue":115,"_process":3,"fbjs/lib/ExecutionEnvironment":140,"fbjs/lib/camelizeStyleName":142,"fbjs/lib/hyphenateStyleName":153,"fbjs/lib/memoizeStringOnly":160,"fbjs/lib/warning":165}],15:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./PooledClass":33,"_process":3,"fbjs/lib/invariant":154}],16:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":21,"./ReactMultiChildUpdateTypes":77,"./ReactPerf":81,"./setInnerHTML":134,"./setTextContent":135,"_process":3,"fbjs/lib/invariant":154}],19:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":3,"fbjs/lib/invariant":154}],20:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":19,"./ReactPerf":81,"./quoteAttributeValueForBrowser":132,"_process":3,"fbjs/lib/warning":165}],21:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":3,"fbjs/lib/ExecutionEnvironment":140,"fbjs/lib/createNodesFromMarkup":145,"fbjs/lib/emptyFunction":146,"fbjs/lib/getMarkupWrap":150,"fbjs/lib/invariant":154}],22:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginRegistry":26,"./EventPluginUtils":27,"./ReactErrorUtils":66,"./accumulateInto":112,"./forEachAccumulated":120,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],26:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":3,"fbjs/lib/invariant":154}],27:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":24,"./ReactErrorUtils":66,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],28:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":24,"./EventPluginHub":25,"./accumulateInto":112,"./forEachAccumulated":120,"_process":3,"fbjs/lib/warning":165}],29:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypeLocations":83,"./ReactPropTypes":84,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],32:[function(require,module,exports){
/**
...
},{"_process":3,"fbjs/lib/invariant":154}],34:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstanceMap":72,"./findDOMNode":118,"_process":3,"fbjs/lib/warning":165}],36:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactReconciler":86,"./instantiateReactComponent":128,"./shouldUpdateReactComponent":136,"./traverseAllChildren":137,"_process":3,"fbjs/lib/warning":165}],38:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactComponent":40,"./ReactElement":62,"./ReactNoopUpdateQueue":79,"./ReactPropTypeLocationNames":82,"./ReactPropTypeLocations":83,"_process":3,"fbjs/lib/emptyObject":147,"fbjs/lib/invariant":154,"fbjs/lib/keyMirror":157,"fbjs/lib/keyOf":158,"fbjs/lib/warning":165}],40:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactNoopUpdateQueue":79,"./canDefineProperty":114,"_process":3,"fbjs/lib/emptyObject":147,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],41:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":3,"fbjs/lib/invariant":154}],43:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./ReactComponentEnvironment":42,"./ReactCurrentOwner":44,"./ReactElement":62,"./ReactInstanceMap":72,"./ReactPerf":81,"./ReactPropTypeLocationNames":82,"./ReactPropTypeLocations":83,"./ReactReconciler":86,"./ReactUpdateQueue":92,"./shouldUpdateReactComponent":136,"_process":3,"fbjs/lib/emptyObject":147,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],44:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":62,"./ReactElementValidator":63,"_process":3,"fbjs/lib/mapObject":159}],49:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":18,"./DOMPropertyOperations":20,"./ReactMount":75,"./ReactPerf":81,"_process":3,"fbjs/lib/invariant":154}],51:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":31,"./Object.assign":32,"./ReactDOMIDOperations":50,"./ReactMount":75,"./ReactUpdates":93,"_process":3,"fbjs/lib/invariant":154}],52:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./ReactChildren":38,"./ReactDOMSelect":53,"_process":3,"fbjs/lib/warning":165}],53:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":31,"./Object.assign":32,"./ReactMount":75,"./ReactUpdates":93,"_process":3,"fbjs/lib/warning":165}],54:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":18,"./DOMPropertyOperations":20,"./Object.assign":32,"./ReactComponentBrowserEnvironment":41,"./ReactMount":75,"./escapeTextContentForBrowser":117,"./setTextContent":135,"./validateDOMNesting":138,"_process":3}],57:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":31,"./Object.assign":32,"./ReactDOMIDOperations":50,"./ReactUpdates":93,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],58:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactCurrentOwner":44,"./canDefineProperty":114,"_process":3}],63:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":44,"./ReactElement":62,"./ReactPropTypeLocationNames":82,"./ReactPropTypeLocations":83,"./canDefineProperty":114,"./getIteratorFn":125,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],64:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":88,"_process":3,"fbjs/lib/invariant":154}],72:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactChildren":38,"./ReactClass":39,"./ReactComponent":40,"./ReactDOMFactories":48,"./ReactElement":62,"./ReactElementValidator":63,"./ReactPropTypes":84,"./ReactVersion":94,"./onlyChild":131,"_process":3}],74:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildReconciler":37,"./ReactComponentEnvironment":42,"./ReactCurrentOwner":44,"./ReactMultiChildUpdateTypes":77,"./ReactReconciler":86,"./flattenChildren":119,"_process":3}],77:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"_process":3,"fbjs/lib/invariant":154}],79:[function(require,module,exports){
(function (process){
/**
...
},{"_process":3,"fbjs/lib/warning":165}],80:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":3,"fbjs/lib/invariant":154}],81:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactDefaultBatchingStrategy":58,"./ReactElement":62,"./ReactInstanceHandles":71,"./ReactMarkupChecksum":74,"./ReactServerBatchingStrategy":89,"./ReactServerRenderingTransaction":91,"./ReactUpdates":93,"./instantiateReactComponent":128,"_process":3,"fbjs/lib/emptyObject":147,"fbjs/lib/invariant":154}],91:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactCurrentOwner":44,"./ReactElement":62,"./ReactInstanceMap":72,"./ReactUpdates":93,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],93:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":15,"./Object.assign":32,"./PooledClass":33,"./ReactPerf":81,"./ReactReconciler":86,"./Transaction":110,"_process":3,"fbjs/lib/invariant":154}],94:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./PooledClass":33,"_process":3,"fbjs/lib/emptyFunction":146,"fbjs/lib/warning":165}],103:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":3,"fbjs/lib/invariant":154}],111:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":3,"fbjs/lib/invariant":154}],113:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"_process":3,"fbjs/lib/warning":165}],117:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":44,"./ReactInstanceMap":72,"./ReactMount":75,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],119:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":137,"_process":3,"fbjs/lib/warning":165}],120:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactCompositeComponent":43,"./ReactEmptyComponent":64,"./ReactNativeComponent":78,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],129:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":62,"_process":3,"fbjs/lib/invariant":154}],132:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":44,"./ReactElement":62,"./ReactInstanceHandles":71,"./getIteratorFn":125,"_process":3,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}],138:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"_process":3,"fbjs/lib/emptyFunction":146,"fbjs/lib/warning":165}],139:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 *
...
},{"./emptyFunction":146,"_process":3}],140:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":140,"./createArrayFromMixed":144,"./getMarkupWrap":150,"./invariant":154,"_process":3}],146:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":140,"./invariant":154,"_process":3}],151:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":154,"_process":3}],158:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./emptyFunction":146,"_process":3}],166:[function(require,module,exports){
'use strict';
